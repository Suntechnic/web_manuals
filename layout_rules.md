...
1 Изображения макета должны быть сгруппированы по каталогам.

2 Один каталог изображений не должен содержать более 20 файлов.

3 В одном каталоге не должны находится файлы разных форматов.

4 Изображения-заглушки не должны находится вместе с изображениями которые будут реально использоваться на сайте.